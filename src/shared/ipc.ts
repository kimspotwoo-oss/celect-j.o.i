export const IPC_CHANNELS = {
  ...
  SETTINGS_GET_IMAGE_PROVIDER: 'settings:getImageProvider',
  SETTINGS_SET_IMAGE_PROVIDER: 'settings:setImageProvider',
  SETTINGS_GET_LOCAL_SD_URL: 'settings:getLocalSdUrl',
  SETTINGS_SET_LOCAL_SD_URL: 'settings:setLocalSdUrl',
  CARD_LIST: 'card:list',
  CARD_LOAD: 'card:load',
  CARD_SAVE: 'card:save',
